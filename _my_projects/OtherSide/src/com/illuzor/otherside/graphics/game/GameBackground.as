package com.illuzor.otherside.graphics.game {
	...
	public final class GameBackground extends Sprite {
		...
		public function GameBackground(w:uint, h:uint, textures:Vector.<Texture>) {
		...
		private final function fillBackground(back1:Sprite, back2:Sprite, amount:uint):void {
			...
			for (var i:int = 0; i < amount; i++) {
				...
				var starTexture:Texture = textures[randomInt(0, textures.length - 1)];
